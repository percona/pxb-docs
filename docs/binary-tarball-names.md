...
| Type          | Name                                                                  |
|---------------|-----------------------------------------------------------------------|
| Minimal       | percona-xtrabackup-{{release}}-Linux.x86_64.glibc2.17-minimal.tar.gz |
| Full          | percona-xtrabackup-{{release}}-Linux.x86_64.glibc2.17.tar.gz          |
| Minimal       | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.28-minimal.tar.gz      |
| Full          | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.28.tar.gz            |
| Minimal       | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.31-minimal.tar.gz      |
| Full          | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.31.tar.gz            |
| Minimal       | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.34-minimal.tar.gz      |
| Full          | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.34.tar.gz            |
| Minimal       | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.35-minimal.tar.gz      |
| Full          | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.35.tar.gz            |
| Minimal       | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.36-minimal.tar.gz      |
| Full          | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.36.tar.gz            |
| Minimal       | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.39-minimal.tar.gz      |
| Full          | percona-xtrabackup-{{release}}-Linux-x86_64.glibc2.39.tar.gz            |                                                                                   |
