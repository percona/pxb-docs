...
[PXB-3624](https://perconadev.atlassian.net/browse/PXB-3624): Fixed an issue where xbcloud could crash because libcurl attempted to use a libev event loop after it had already been shut down. This affected libcurl versions impacted by [CVE-2025-0665](https://github.com/advisories/GHSA-cc57-hgv8-p56r).
