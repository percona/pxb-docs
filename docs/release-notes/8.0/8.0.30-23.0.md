...
[PXB-2874](https://jira.percona.com/browse/PXB-2874): When Percona XtraBackup generated a new master key on [--copy-back](../../xtrabackup-option-reference.md#copy-back) or [--move-back](../../xtrabackup-option-reference.md#move-back), the master key id was reset back to 1.
