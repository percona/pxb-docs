...
1. Open the [Percona XtraBackup Jira project](https://jira.percona.com/projects/PXB/issues) in your browser.
...
!!! tip "Shortcut to the issue creation screen"
    ...
    To go directly to the Create Issue form, navigate to the [Percona XtraBackup Jira project](https://jira.percona.com/projects/PXB/issues) and click **Create**.
...
2. Fork the repository (if you haven't already):
    ...
    ```shell
        gh repo fork percona/pxb-docs
    ```

3. Clone your forked repository:

    ```shell
        gh repo clone <your_github_name>/pxb-docs
        cd pxb-docs
    ```
...
2. Clone your forked repository to your machine:
    ...
    ```shell
        git clone https://github.com/<your_github_name>/pxb-docs.git
        cd pxb-docs
    ```

    !!! note "SSH alternative"
    
        If you have SSH keys set up with GitHub, you can use `git@github.com:<your_github_name>/pxb-docs.git` instead.
