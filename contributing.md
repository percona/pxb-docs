...
Open a browser and navigate to `http://127.0.0.1:8000/percona-xtrabackup/8.4/`, `http://127.0.0.1:8000/percona-xtrabackup/8.0/` or `http://127.0.0.1:8000/percona-xtrabackup/2.4/`  to see the HTML files. You may need to navigate to the document that you have changed.


### Building the PDF documentation

To build the PDF documentation, open the `site/print_page.html` in your browser, for example, https://docs.percona.com/percona-xtrabackup/8.4/print_page.html. Save it as PDF. Depending on the browser, you may need to select the **Export to PDF**, **Print - Save as PDF** or just **Save** and select PDF as the output format.
